  ...
  <ol>
	<div class="linkBar">
		...
		<div class="actualLink">
			...
			<form action="index.php" class="pure-form" method="post">
				<input id="titleInput"type="text" class="pure-input-1-2" name = "titleInput"placeholder="Title"><br>
				<p class="spacerP"> </p>
				<textarea id="txtarea"class="pure-input-1-2" name="txtarea"placeholder="text"></textarea> <br>
				<p class="spacerP"> </p>
